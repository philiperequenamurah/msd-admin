...
// @Component({
//   selector: 'msd-status-charts',
//   styleUrls: ['./status-charts.component.scss'],
//    template: `
//     <div echarts [options]="options" class="echart" (chartInit)="onChartInit($event)"></div>
//   `,

// })
// export class StatusChartsComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
