...
// @Component({
//   selector: 'msd-status-ares',
//   templateUrl: './status-ares.component.html',
//   styleUrls: ['./status-ares.component.scss']
// })
// export class StatusAresComponent implements OnInit, AfterViewInit, OnDestroy {
